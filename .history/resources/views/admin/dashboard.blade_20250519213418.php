...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="bg-gray-800 rounded-xl shadow-sm p-8 text-center">
        ...
        <div class="mt-8">
            <span class="inline-block bg-blue-700 text-white px-4 py-2 rounded-lg font-semibold">Je bent ingelogd als: <span class="text-blue-300">bart.vandijk@zerodayfanshop.nl</span></span>
        </div>
    </div>
</div>
@endsection
